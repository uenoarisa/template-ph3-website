<header id="js-header" class="l-header p-header flex">
    <div class="p-header__logo"><img src="<?php echo e(asset('img/logo.svg')); ?>" alt="POSSE"></div>
  ...
  </header><?php /**PATH /work/web/resources/views/components/header.blade.php ENDPATH**/ ?>